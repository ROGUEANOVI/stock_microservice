...
public class BrandExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleInvalidBrandNameException(InvalidBrandNameException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Collections.singletonMap(ExceptionMessage.KEY_MESSAGE, ex.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, String>> handleBrandAlreadyExistsException(BrandAlreadyExistsException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(Collections.singletonMap(ExceptionMessage.KEY_MESSAGE, ex.getMessage()));
    }
}
